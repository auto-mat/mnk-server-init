...
fileSystems."/boot" = {
  ...
  services.cron = {
    ...
    systemCronJobs = [
      ...
      "* 8 * * * root /home/mtbmap/rendering-PNK-ZM/Devel/systemdeploy/set_network_bandwidth.sh
      "* 18 * * * root /home/mtbmap/rendering-PNK-ZM/Devel/systemdeploy/set_network_bandwidth.sh remove
